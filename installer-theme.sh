...
ControlPanelv2() {
bash <(curl -s https://raw.githubusercontent.com/GZSTORE/ctrlpanelzyuga/main/installctrlpanel.sh)
}
...
while [ "$done" == false ]; do
  options=(
    ...
    "Install NightCore Theme (Only All Version ubuntu)"
    "Install Control Panel v2 (Only All Version ubuntu)"
